...
from os_vm_expire.api import middleware as mw
...
class ContextMiddleware(BaseContextMiddleware):
    ...
    def _get_anonymous_context(self):
        ...
        return os_vm_expire.context.RequestContext(**kwargs)
...
class UnauthenticatedContextMiddleware(BaseContextMiddleware):
    ...
    def process_request(self, req):
        ...
        context = os_vm_expire.context.RequestContext(**kwargs)

        req.environ['os_vm_expire.context'] = context
